...
<body>
    ...
    <div id="main" class="container">
        <div class="row">
            ...
            <div class="col">
                <h4 class="text-center">Registered Pets</h4>
                                ...
                                for($x = count($data)-1; $x >= 0; $x--){
                                    ...
                                    if($isActive == 'true'){
                                        echo "
                                            ...
                                            <td>$age</td>
                                            <td>$gender</td>
                                            <td><button onclick='deleteList()'>Delete</button></td>
                                            </tr>

                                            <script>
                                                function deleteList(){
                                                    window.location.replace('/Clinic/api/delete-registered-pets.php?id=$id?name=$name')
                                                }
                                            </script>
                                        ";
                                    }
